...
class _ItemsPerCategoryState extends State<ItemsPerCategory> {
  ...
  //TODO: pre-load images so that it won't show grey shadow first - this is already being worked on by Abderrahmane
  @override
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: MakeItem(
                      ...
                      quantity: itemDocs[index].data()['quantity'].toString(),
                      image: itemDocs[index].data()['itemImage'],
                      buyDate: itemDocs[index].data()['buyDate'],
                      supplier: itemDocs[index].data()['supplier'],
                      buyPrice: itemDocs[index].data()['buyPrice'].toString(),
                      sellPrice: itemDocs[index].data()['sellPrice'].toString(),
                    ),
                  ),
                ),
              );
